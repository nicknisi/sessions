...
// author exists.
//
// Pure, and deliberately tiny. It imports only the `MergedShard` TYPE — an erased
...
import type { MergedShard } from './portable';
 ...
 * `totalPhrasings`, and a future editor WILL be tempted, because a merged shard is
 ...
 * (src/shards/mine.ts:234-237) with no write-back path from the triage skill. The two
