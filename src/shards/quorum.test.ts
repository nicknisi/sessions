...
// "obvious" implementation (`return shard.totalPhrasings`) fails loudly: every fixture
...
function merged(authors: string[], totalPhrasings: number): MergedShard {
  return {
...
describe('quorum', () => {
  ...
  test('is 0 for a shard with no contributors rather than throwing', () => {
